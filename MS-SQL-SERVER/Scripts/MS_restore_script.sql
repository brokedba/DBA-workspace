/*
The files have the following naming format    @dbName='DbDemo' and the @backupPath=N'E:\SALBACKUP\backup\'
Full backup - BAK
Differential backup - DIF
Transaction log backup - TRN
dbName_YYYYMMDDHHMM.xxx
We are creating backups on following schedule:           
